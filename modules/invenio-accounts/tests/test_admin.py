...
# .tox/c1/bin/pytest --cov=invenio_accounts tests/test_admin.py::test_admin -vv -s --cov-branch --cov-report=term --basetemp=/code/modules/invenio-accounts/.tox/c1/tmp --full-trace
