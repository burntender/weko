...
# .tox/c1/bin/pytest --cov=invenio_accounts tests/test_invenio_accounts.py::test_accounts_settings_blueprint -vv -s --cov-branch --cov-report=term --basetemp=/code/modules/invenio-accounts/.tox/c1/tmp --full-trace
...
# .tox/c1/bin/pytest --cov=invenio_accounts tests/test_invenio_accounts.py::test_view -vv -s --cov-branch --cov-report=term --basetemp=/code/modules/invenio-accounts/.tox/c1/tmp --full-trace
def test_view(app):
    """Test view."""
    with app.app_context():
        with app.test_client() as client:
...
# .tox/c1/bin/pytest --cov=invenio_accounts tests/test_invenio_accounts.py::test_cookies -vv -s --cov-branch --cov-report=term --basetemp=/code/modules/invenio-accounts/.tox/c1/tmp --full-trace
